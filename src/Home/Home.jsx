          ...
          {pane ? (
            ...
            <div className="card-body tab-pane" role="tabpanel" id="info">
              <p>
                ...
                two people using their hands. The rules to play are pretty
                simple: Rock wins agains Scissors - Scissors wins against Paper
                - and Paper wins against Rock. Best out of 5, wins.
              </p>
            </div>
          )}
        </div>
